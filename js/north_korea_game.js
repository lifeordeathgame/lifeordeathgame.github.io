...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(z)) {
		...
		if (rannum <= a) {
		    ...
		    a += 15; alert("Press space, w, or up arrow to jump, and s, shift, or down arrow to crouch.")
var murica;
var badManKim = [];
var myScore;
var mySound;
...
var e = 100;
function startGame() {
    murica = new component(180, 90, "https://upload.wikimedia.org/wikipedia/en/thumb/a/a4/Flag_of_the_United_States.svg/1280px-Flag_of_the_United_States.svg.png", 90, window.innerHeight - 90
, "image");
    myScore = new component("30px", "Consolas", "Red", 50, 50, "text");
    //myHighScore = new component("100px", "Consolas", "Black", window.innerWidth / 2 - 100, window.innerHeight / 2 - 100, "text");
    //mySound = new sound("http://northkoreaworld.com/Vivian and Nathan Duet.mp3");
...
function updateGameArea() {
    ...
    score = (myGameArea.frameNo / 45);
    score = Math.ceil(score);
    for (i = 0; i < badManKim.length; i += 1) {
        if (murica.crashWith(badManKim[i])) {
            myGameArea.stop();
	    myGameArea.clear();
	    alert("You died! Your score was " + score +". " + ranfact);
	    startGame();
    ...
    if (myGameArea.frameNo == 1 || everyinterval(z)) {
		...
		if (rannum <= a) {
        	//normal jump
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 75, "image"));
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 310, "image"));
		    a -= 25;
		    b -= 25; 
		    c -= 15; 
		    d -= 15; 
		    ...
		    //crouch jump
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 145, "image"));
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 75, "image"));
		    a += 15;
			b += 15; 
			c -= 15; 
		    ...
		    //duck
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 145, "image"));
		    badManKim.push(new component(75, 75, "http://northkoreaworld.com/imgs/Kim.png", x, myGameArea.canvas.height - 220, "image"));
		    a += 15; 
			b += 15; 
			c += 25;
			d += 25;
...
function checkKey(e) {
    ...
    if (e.keyCode == '32' || e.keyCode == '87' || e.keyCode == '38') {
    	if (murica.y >= myGameArea.canvas.height - 90) {
    	    accelerate(-12)
            clearmove()
        }
    }
