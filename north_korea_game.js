...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(z)) {
		...
		if (rannum <= 5) {
		    ...
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 75, "image"));
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 310, "image"));

		}
		else if (rannum >= 6 && rannum <= 7 ){
		    //y = myGameArea.canvas.height - 145;
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 145, "image"));
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 75, "image"));
		    ...
		    //y = myGameArea.canvas.height - 145;
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 145, "image"));
		    myObstacles.push(new component(75, 75, "Animated GIF-source.gif", x, myGameArea.canvas.height - 220, "image"));
